...
export const BlogIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    fill="none"
    {...props}
    className={clsx(' text-bluepipe-orange', props.className)}
  >
    <rect width={40} height={40} fill="currentColor" fillOpacity={0.1} rx={20} />
    <path
      fill="currentColor"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <path fill="currentColor" d="M20.2 26.4a.8.8 0 1 0 0 1.6h7a.8.8 0 0 0 0-1.6h-7Z" />
  </svg>
);

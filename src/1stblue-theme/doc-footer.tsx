    ...
    >
      <div className={clsx()}>
        <a
          ...
          className={clsx('text-bluepipe-link-light ', 'text-xs content-4xl:text-sm', 'underline')}
        >
          Edit this page
        </a>
      </div>
      <div className={clsx('text-gray-500', 'text-xs leading-4 content-4xl:text-base content-4xl:leading-6')}>

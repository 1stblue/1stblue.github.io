  ...
  return (
    <>
      <header className={clsx('sticky', 'top-0', 'z-10')}>
        ...
        />
        <div className={clsx('relative', 'z-[1]', 'p-4', 'landing-sm:px-8', 'landing-md:py-5')}>
          <div className={clsx('flex', 'items-center', 'justify-between', 'max-w-[83%]')}>
            <div className={clsx('w-[130px]', 'landing-lg:w-[200px]')}>
              <Link to="/" className={'flex items-center font-semibold no-underline text-gray-900'}>
                <BluepipeLogoIcon />
                &nbsp;&nbsp;&nbsp;&nbsp;Bluepipe
              </Link>
            </div>
            <button
              type="button"
              className={clsx('text-gray-900', 'block landing-md:hidden')}
              onClick={() => setIsModalOpen(true)}
            >
              <HamburgerIcon />
            </button>
            <div className={clsx('hidden landing-md:flex', 'flex-1', 'items-center', 'gap-8')}>
              <Menu />
            </div>
            <div
              className={clsx(
            ...
            ></div>
            <MobileMenuModal isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} />
          </div>
        </div>
        {trackProgress && (
          <div className={clsx('w-full', 'h-0.5', 'translate')}>
            <motion.div
              className={clsx('h-full', 'bg-bluepipe-blue')}

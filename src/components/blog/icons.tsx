...
export const ChevronLeft = (props: React.SVGProps<SVGSVGElement>): JSX.Element => (
  <svg
    aria-hidden="true"
    className="h-5 w-5"
    fill="currentColor"
...
export const ChevronRight = (props: React.SVGProps<SVGSVGElement>): JSX.Element => (
  <svg
    aria-hidden="true"
    className="h-5 w-5"
    fill="currentColor"

...
export default function Customer() {
  return (
    <section>
      <div className="w-[1120px] m-auto mt-[40px] pb-[96px] flex flex-col justify-center items-center">
        ...
        <div className='w-[90%] m-auto flex gap-[32px] mt-[-106px]'>
          ...
          bg-[#E8E9FB] flex flex-col items-center'>
            ...
            <div>
            <img className="mt-[24px] rounded-[100px]" src="/Avatar1.svg" width={56} height={56} alt='avatar1' />
            </div>
          ...
          bg-[#F0F8F9] flex flex-col items-center'>
            ...
            <div>
            <img className="mt-[24px] rounded-[100px]" src="/Avatar2.svg" width={56} height={56} alt='avatar2' />
            </div>
            <div className='mt-[24px]
            font-sans font-[400] text-[16px] leading-[25.6px] text-[#000000]'>
          ...
          bg-[#F8F9F4] flex flex-col items-center'>
            ...
            <div>
            <img className="mt-[24px] rounded-[100px]" src="/Avatar3.webp" width={56} height={56} alt='avatar3' />
            </div>
            <div className='mt-[24px]
            font-sans font-[400] text-[16px] leading-[25.6px] text-[#000000]'>

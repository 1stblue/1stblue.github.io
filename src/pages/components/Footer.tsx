          ...
          <div className='flex flex-col py-[83px] gap-[82px]'>
            <div className='flex justify-between'>
              <div className='text-white'>
                <img src="/logo-footer.svg" alt='logo' width={124.02} height={28.8} />
                <div className='mt-[31.2px]'>
                  ...
                  <p className=' mt-[12px]
                   font-sans font-[400] text-[16px] leading-[19px]'>
                    <a href={`mailto:${MAIL_ADDRESS}`} className='relative text-[14px] group hover:no-underline hover:text-current'>
                      {MAIL_ADDRESS}
            ...
            border-t-[1px] border-[#FFFFFF4D]'>
              ...
              font-sans font-[400] text-[12px] leading-[16.8px]'>
                &copy; 2022-2025 杭州萃蓝网络科技有限公司 保留所有权利</div>
              <div className='mt-[32px]

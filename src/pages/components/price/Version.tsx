    ...
    return (
        <section>
          ...
          font-sans font-[600] text-[36px] leading-[50.4px] text-center text-[#000000]">
                    ...
                    <Table className="shadcn-table mt-[24px]">
          ...
          border-b-[1px] border-b-[#666666]"
                        >
                            <TableRow className="text-[#000000]">
                                <TableHead></TableHead>
                                <TableHead className=" text-[#000000] text-center w-[302px]">基础版</TableHead>
                                <TableHead className=" text-[#000000] text-center w-[302px]">专业版</TableHead>
                                <TableHead className=" text-[#000000] text-center w-[302px]">旗舰版</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                                                ...
                                                if (typeof n === 'boolean') {
                                                    return <TableCell key={index}>
                                                        <img className="block mx-auto"
                                                             src={`/icons/${n === true ? 'right' : 'null'}.svg`} alt=""
                                                             width={20} height={20}/>
                                                    </TableCell>
                                                } else {

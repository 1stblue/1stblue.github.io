                        ...
                        <div
                         ...
                         >
                          ...
                          <div>
                            ...
                            <div className="flex justify-center items-center rounded-[8px] bg-[#0165FF] hover:bg-[#0165FF] mt-[20px] w-[304px] h-[52px]" onClick={() => index > 0 && mailto()} >
                                <ArrowButton
                                  textWhite
                                    ...
                                    {item.list.map((n, index) => (
                                        <div key={index} className="flex gap-[15px] font-sans font-[400] text-[16px] leading-[32px] text-[#666666]">
                                            <div className="flex-shrink-0 w-[20px] h-[32px] flex items-center">
                                              <img className="inline-block" src={'/icons/right.svg'} alt="" width={20} height={20} />
                                            </div>
                                            <p>{n}</p>
                                        </div>
                                    ))}

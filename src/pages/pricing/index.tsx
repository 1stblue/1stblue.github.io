...
const TableItem = ({ description, community, enterprise, activeTab, isLast }) => {
  return (
    <div className={clsx('flex', 'w-full', !isLast && 'border-b', !isLast && 'border-b-gray-200')}>
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className={clsx('font-semibold', 'py-0 pricing-content:py-2', 'my-1')}>Free Forever!</div>
        </div>
        <div
          className={clsx(
            'w-px',
        ...
        >
          <div className={clsx('font-semibold')}>
            🚀{' '}
            <span className={clsx('bg-pricing-text-bg-enterprise', 'text-transparent', 'bg-clip-text')}>
              Enterprise
            </span>
          </div>
          <div
          ...
          >
            <PricingRainbowButton href="https://s.bluepipe.dev/enterprise" />
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className={clsx('flex', 'flex-col', 'gap-4')}>
      ...
      >
        ...
        <span className={clsx('text-transparent', 'bg-pricing-text-bg-red', 'bg-clip-text')}>
          enterprise-level
        </span>{' '}
        capabilites
      </div>
...
const PricingTableSectionWrapper = ({ children }) => {
  return (
    <div className={clsx('border', 'border-t-0', 'border-b-0', 'border-gray-200', 'flex', 'flex-col')}>
      {children}
    </div>
  );
};
...
const pricingData = [
  {
    ...
    items: [
      {
        description: 'License',
        community: <PricingText>Open-source under MIT license</PricingText>,
        enterprise: <PricingText bold>Open-source under Enterprise license</PricingText>
      }
    ]
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        enterprise: <PricingText bold>Private Slack Channel</PricingText>
      },
      {
      ...
      },
      {
        ...
        enterprise: (
          <div className="flex items-center justify-center flex-wrap gap-4">
            ...
            <PricingOpenaiIcon name="OpenAI" className="text-gray-1000 " />
            <PricingAwsIcon name="Amazon Web Services" className="text-gray-1000 " />
      ...
      },
      {
        ...
        enterprise: (
          <div className="flex items-center justify-center flex-wrap gap-4">
            ...
            <PricingOktaIcon name="Okta" className="text-gray-1000 " />
            <PricingAzureIcon name="Azure" />
            <PricingGoogleIcon name="Google" />
            <PricingScimIcon name="SCIM" className="text-gray-1000 " />
...
function Pricing() {
  const [activeTab, setActiveTab] = React.useState<'community' | 'enterprise'>('community');
  const intervalRef = React.useRef<NodeJS.Timer>(null);

  React.useEffect(() => {
    const interval = setInterval(() => {
      setActiveTab(prev => (prev === 'community' ? 'enterprise' : 'community'));
    }, 5000);
  ...
  return (
    <>
      ...
      >
        ...
        <div className={clsx('px-4', 'w-full', 'pt-8', 'pricing-content-sm:pt-12', 'pricing-content:pt-20')}>
          <div
            className={clsx(

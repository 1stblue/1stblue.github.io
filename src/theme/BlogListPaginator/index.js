      ...
      >
        <li>
          <Link
            ...
            className={clsx('text-gray-500 ', 'rounded', 'hover:no-underline', 'hover:no-underline', {
        ...
        <li>
          <Link
            to={currentPage === lastPage ? undefined : `${basePath}/page/${currentPage + 1}`}
            className={clsx('text-gray-500 ', 'rounded', 'hover:no-underline', {
